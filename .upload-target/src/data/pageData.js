const pageData = {
  header: {
    ...
    searchPlaceholder: '22Search in fresh grocery products...'
  },
  heroSlides: {
  ...
  navigation: {
    searchCategories: ['3All Categories', 'Fruits', 'Vegan Meat', 'Seafood', 'Dairy', 'Bakery', 'Beverages', 'Beer & Liquor', 'Vegetable'],
    utilities: [
      { label: 'Promotions' },
